-- Production security users for the existing cos20031 MariaDB database.
-- Run this once as a DBA/root user on cos20031-db before deploying the app
-- with DB_USER=archery_scorer.
